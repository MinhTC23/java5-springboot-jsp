...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-7">
            <form:form action="/pay-ok" method="post" modelAttribute="bill">
                ...
                <br>
                <form:button type="submit" class="btn btn-success" id="addButton">Pay</form:button>
            </form:form>
        </div>
        <div class="col-lg-5">
            <h1>Giỏ hàng</h1>
            <table class="table">
                ...
                <c:forEach items="${cartDetail.list}" var="cd">
                    <tr>
